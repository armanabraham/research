...
### Description
Reproducing data analysis and figures reported in "Low intensity TMS enhances perception of visual stimuli" by Arman Abrahamyan, Colin Clifford, Ehsan Arabzadeh and Justin Harris [published in Brain Stimulation](http://www.sciencedirect.com/science/article/pii/S1935861X15010141). You can accesss single-subject data and reproduce the analysis by downloading files from [GitHub page](https://github.com/armanabraham/research/tree/master/Weak_TMS_Enhances_Perception). If you use RStudio, load the downloaded project and reproduce the analysis by running Data\_analysis\_and_figures.Rmd file.
...
# Effect size as r
paste('r =', sqrt(exp1_ttestNoTMSvs90$statistic[[1]]^2/(exp1_ttestNoTMSvs90$statistic[[1]]^2+exp1_ttestNoTMSvs90$parameter[[1]])))
# Cohen's d
